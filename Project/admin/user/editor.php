<?php
    ...
    $id = $fullname = $email = $msg = $phone_number = $address = $role_id = '';
            ...
            <div class="panel-body">
                <form method="post" onsubmit="return validateForm();">
                    ...
                    <div class="form-group">
                      ...
                      <input <?=($id > 0?'':'required="true"')?> type="password" class="form-control" id="confirmation_pwd" name="confirmation_pwd" minlength="6">
                    </div>
